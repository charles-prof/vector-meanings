...
export function LessonSidebar({ 
  ...
  return (
    <aside className="w-80 border-r border-white/5 bg-black/40 flex flex-col h-full overflow-hidden">
            ...
            return (
              ...
              >
                <div className={cn(
                  ...
                  completed ? "text-emerald-400" : (isActive ? "text-white" : "text-white/20 group-hover:text-white/40")
                )}>
